...
const About = () => {
    return (
        <section className='h-screen flex justify-center items-center ' style={{ backgroundImage: `url(${background})` }} >
            <div className='about bg-zinc-900 bg-opacity-75  rounded-md p-8 m-8 flex justify-center items-center '>
